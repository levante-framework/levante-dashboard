    ...
    setup(props, { emit, slots }) {
      return () =>
        h('div', { 'data-cy': 'roar-data-table' }, [
          ...
          slots.filterbar?.(),
          props.data[0]
            ? slots.expansion?.({ data: props.data[0] })
            : null,
        ]);
    },
  }),
...
describe('ProgressReportFeature.vue', () => {
  ...
  it('exports all and selected progress rows as CSV data', async () => {
    ...
    expect(mockExportCsv).toHaveBeenNthCalledWith(
      ...
      [
        {
          "Math Public Started at": new Date(
          ...
          "User Type": "Student",
          "Vocabulary Public Started at": new Date(
            "2024-01-10T00:00:00.000Z",
          ).toLocaleString(),
          "Vocabulary Public Completed at": new Date(
            "2024-01-12T00:00:00.000Z",
          ).toLocaleString(),
        },
        {
        ...
        },
        {
          ...
          "Math Public Completed at": new Date(
            "2024-01-09T00:00:00.000Z",
          ).toLocaleString(),
          School: "",
          UID: "teacher-1",
