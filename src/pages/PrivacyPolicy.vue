<template>
  <main class="privacy-policy-page container py-5">
    <section class="surface-card border-round p-4 md:p-5">
      <h1 class="mt-0 mb-2 font-bold">Privacy Policy for the LEVANTE Project</h1>

      <h2 class="font-semibold">Overview</h2>
      <p><strong>Last updated:</strong> June 24, 2025</p>
      <p>
        This Privacy Policy explains how the LEVANTE project collects, uses, stores, and protects personal information
        when participants use the website and associated web applications. LEVANTE is committed to protecting privacy
        and complying with international laws including GDPR and CCPA/CPRA.
      </p>
      ...
      <ul>
        ...
        <li>
          From participants: Technical data such as IP address, browser type, and usage data for site functionality and
      ...
      <h2 class="font-semibold">3. Legal Bases for Processing (GDPR)</h2>
      <ul>
      ...
      <h2 class="font-semibold">4. Data Retention</h2>
      <p>
        Personal information is retained only as long as needed for the documented purposes or as required by law, then
        deleted or anonymized.
      </p>

      <h2 class="font-semibold">5. Your Rights</h2>
      ...
      <h2 class="font-semibold">6. Cookies and Tracking</h2>
      <p>
      ...
      <h2 class="font-semibold">10. Contact</h2>
      <p>
      ...
      <h2 class="font-semibold">Special Note: We do not sell or Share Personal Information</h2>
