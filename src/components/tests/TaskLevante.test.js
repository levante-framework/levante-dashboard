...
vi.mock('@levante-framework/core-tasks/lib/resources/core-tasks.css', () => ({}));

async function mountTaskLevante(props = {}) {
  const wrapper = mount(TaskLevante, {
    props: {
      taskId: 'egma-math',
      ...props,
    },
