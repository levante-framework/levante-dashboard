  ...
  describe('Testing synced administration: Synced Administration 9213176626', () => {
    it('Tests a synced administration', () => {
      cy.login(Cypress.env('participantUsername'), Cypress.env('participantPassword'));
      cy.visit('/', { timeout: 2 * timeout });
      cy.selectAdministration('Synced Administration 9213176626');
      testSpecs.forEach((spec) => {
        ...
        testGame(spec, 'Synced Administration 9213176626');
      });
      cy.log(`Found administration: Synced Administration 9213176626`);
    });
  });
