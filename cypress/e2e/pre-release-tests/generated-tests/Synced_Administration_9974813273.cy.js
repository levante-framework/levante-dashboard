  ...
  describe('Testing synced administration: Synced Administration 9974813273', () => {
    it('Tests a synced administration', () => {
      cy.login(Cypress.env('participantUsername'), Cypress.env('participantPassword'));
      cy.visit('/', { timeout: 2 * timeout });
      cy.selectAdministration('Synced Administration 9974813273');
      testSpecs.forEach((spec) => {
        ...
        testGame(spec, 'Synced Administration 9974813273');
      });
      cy.log(`Found administration: Synced Administration 9974813273`);
    });
  });
