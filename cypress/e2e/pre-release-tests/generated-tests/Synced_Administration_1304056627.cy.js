  ...
  describe('Testing synced administration: Synced Administration 1304056627', () => {
    it('Tests a synced administration', () => {
      cy.login(Cypress.env('participantUsername'), Cypress.env('participantPassword'));
      cy.visit('/', { timeout: 2 * timeout });
      cy.selectAdministration('Synced Administration 1304056627');
      testSpecs.forEach((spec) => {
        ...
        testGame(spec, 'Synced Administration 1304056627');
      });
      cy.log(`Found administration: Synced Administration 1304056627`);
    });
  });
