  ...
  describe('Testing synced administration: Synced Administration 5072430498', () => {
    it('Tests a synced administration', () => {
      cy.login(Cypress.env('participantUsername'), Cypress.env('participantPassword'));
      cy.visit('/', { timeout: 2 * timeout });
      cy.selectAdministration('Synced Administration 5072430498');
      testSpecs.forEach((spec) => {
        ...
        testGame(spec, 'Synced Administration 5072430498');
      });
      cy.log(`Found administration: Synced Administration 5072430498`);
    });
  });
