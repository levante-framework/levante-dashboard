  ...
  describe('Testing synced administration: Synced Administration 6422834691', () => {
    it('Tests a synced administration', () => {
      cy.login(Cypress.env('participantUsername'), Cypress.env('participantPassword'));
      cy.visit('/', { timeout: 2 * timeout });
      cy.selectAdministration('Synced Administration 6422834691');
      testSpecs.forEach((spec) => {
        ...
        testGame(spec, 'Synced Administration 6422834691');
      });
      cy.log(`Found administration: Synced Administration 6422834691`);
    });
  });
