  ...
  describe('Testing synced administration: Synced Administration 7580178810', () => {
    it('Tests a synced administration', () => {
      cy.login(Cypress.env('participantUsername'), Cypress.env('participantPassword'));
      cy.visit('/', { timeout: 2 * timeout });
      cy.selectAdministration('Synced Administration 7580178810');
      testSpecs.forEach((spec) => {
        ...
        testGame(spec, 'Synced Administration 7580178810');
      });
      cy.log(`Found administration: Synced Administration 7580178810`);
    });
  });
