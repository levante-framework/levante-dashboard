  ...
  describe('Testing synced administration: Synced Administration 3937638636', () => {
    it('Tests a synced administration', () => {
      cy.login(Cypress.env('participantUsername'), Cypress.env('participantPassword'));
      cy.visit('/', { timeout: 2 * timeout });
      cy.selectAdministration('Synced Administration 3937638636');
      testSpecs.forEach((spec) => {
        ...
        testGame(spec, 'Synced Administration 3937638636');
      });
      cy.log(`Found administration: Synced Administration 3937638636`);
    });
  });
